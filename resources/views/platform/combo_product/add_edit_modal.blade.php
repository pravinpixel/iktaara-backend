                ...
                <div class="fv-row mb-10">
                    <div class="d-flex flex-column scroll-y me-n7 pe-7" id="kt_modal_add_user_scroll"
                        ...
                        <div class="fv-row mb-7">
                            <label class="required fw-bold fs-6 mb-2">Combo Name</label>
                            <input type="text" name="combo_name"
                                class="form-control form-control-solid mb-3 mb-lg-0" placeholder="Combo Name"
                                value="{{ $info->combo_name ?? '' }}" />
                        </div>
                        <div class="fv-row mb-7">
...
<script>
    ...
    var add_url = "{{ route('combo-product.save') }}";
