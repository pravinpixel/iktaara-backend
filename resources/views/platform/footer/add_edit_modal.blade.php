...
<!--end::Header-->
<!--begin::Body-->
<form id="add_footer_form" class="form" action="#" enctype="multipart/form-data">
                    ...
                    <div class="d-flex flex-column scroll-y me-n7 pe-7" id="kt_modal_add_user_scroll"
                        ...
                        <div class="fv-row mb-7">
                            ...
                            <input type="text" name="name" class="form-control form-control-solid mb-3 mb-lg-0"
                                placeholder="Content" value="{{ $info->name ?? '' }}" />
                        </div>
                         <div class="fv-row mb-7">
                        ...
                        <div class="fv-row mb-7">
                            ...
                            <textarea class="form-control textarea" rows="2" name='description' id="editor">
                                {{ $info->description ?? '' }}
                            </textarea> 
...
<script>
    ...
    var add_url = "{{ route('footers.save') }}";

    // Class definition
    var KTTopbar = function() {
        // Shared variables
        const element = document.getElementById('kt_common_add_form');
        const form = element.querySelector('#add_footer_form');
