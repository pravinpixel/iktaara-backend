...
<!--end::Header-->
<!--begin::Body-->
<form id="add_city_form" class="form" action="#" enctype="multipart/form-data">
                ...
                <div class="fv-row mb-10">
                    <div class="d-flex flex-column scroll-y me-n7 pe-7" id="kt_modal_add_user_scroll"
                        ...
                        <div class="d-flex flex-column mb-7 fv-row">
                            ...
                            <select name="state_id" id="state_id" aria-label="Select a Country" class="form-select form-select-solid fw-bolder">
                        ...
                        <div class="d-flex flex-column mb-7 fv-row">
                            ...
                            <select name="pincode_id" id="pincode_id" aria-label="Select a Country" class="form-select form-select-solid fw-bolder">
                                <option value="">Select a Pincode...</option>
                                @foreach($pincode as $key=>$val)
                                <option value="{{ $val->id }}" @if(isset( $info->pincode_id) && $info->pincode_id == $val->id) selected @endif >{{ $val->pincode }}</option>
                                @endforeach
                        ...
                        <div class="fv-row mb-7">
                            ...
                            <input type="text" name="city" class="form-control form-control-solid mb-3 mb-lg-0"
                                placeholder="City Name" value="{{ $info->city ?? '' }}" />
                        </div>
                        <div class="fv-row mb-7">
                            ...
                            {{-- <input type="text" name="description" class="form-control form-control-solid mb-3 mb-lg-0"
                                ...
                                <textarea class="form-control form-control-solid mb-3 mb-lg-0" placeholder="Description" name="description" id="description" cols="30" rows="10">{{ $info->description ?? '' }}</textarea>
                        </div>
...
<script>
 ...
 $('.mobile_num').keypress(
    ...
    var add_url = "{{ route('city.save') }}";

    // Class definition
    var KTUsersAddRole = function() {
        // Shared variables
        const element = document.getElementById('kt_common_add_form');
        const form = element.querySelector('#add_city_form');
