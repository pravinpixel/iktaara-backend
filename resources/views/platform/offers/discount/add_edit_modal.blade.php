            ...
            <div class="d-flex flex-column scroll-y me-n7 pe-7" id="kt_modal_update_role_scroll">
                <div class="fv-row mb-10">
                    <div class="d-flex flex-column scroll-y me-n7 pe-7" id="kt_modal_add_user_scroll"
                            ...
                            <div class="col-md-6">
                                <div class="fv-row mb-7">
                                    ...
                                    <input type="text" name="discount_name"
                                        class="form-control form-control-solid mb-3 mb-lg-0" placeholder="Discount Name"
                            ...
                            <div class="col-md-6">
                                <div class="fv-row mb-7">
                                    ...
                                    <select name="calculate_type" id="calculate_type"
                                        aria-label="Select a Discount Type" data-control="select2"
                                        data-placeholder="Select Discount Type ..." class="form-select mb-2">
                                        <option value="percentage"
                                            @if (isset($info->calculate_type) && $info->calculate_type == 'percentage') selected="selected" @endif>Percentage
                                        </option>
                                        <option value="fixed_amount"
                                            @if (isset($info->calculate_type) && $info->calculate_type == 'fixed_amount') selected="selected" @endif>Fixed Amount
                                        </option>
                                    </select>
                                </div>
                            </div>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="fv-row mb-7">
                                    ...
                                    <select name="discount_type" id="discount_type" aria-label="Select a Coupon Type"
                                        ...
                                        <option value="4"
                                            @if (isset($info->coupon_type) && $info->coupon_type == '4') selected="selected" @endif>Product
                                            Collection</option>
                                        <option value="5"
                                            @if (isset($info->coupon_type) && $info->coupon_type == '5') selected="selected" @endif>Brands
                                        </option>
                                    </select>
                                </div>
                            </div>
                        ...
                        <div class="row">
                            <div class="col-md-6" id="excludedProductData">
                                <div class="fv-row mb-7">
                                    <label class="fw-bold fs-6 mb-2" id="title">Select Products that are
                                        to be excluded</label>
                                    <select name="excluded_product_id[]" id="excluded_product_id"
                                        aria-label="Select a Product" multiple="multiple"
                                        data-placeholder="Select a Product..." class="form-select mb-2">
                                        <option value=""></option>
                                        @if (isset($excludedProducts) && !empty($excludedProducts))
                                            @foreach ($excludedProducts as $item)
                                                <option value="{{ $item->id }}"
                                                    @if (isset($selected_products) && in_array($item->id, $selected_products)) selected="selected" @endif>
                                                    {{ $item->name ?? ($item->product_name ?? ($item->first_name ?? '')) }}
                                                </option>
                                            @endforeach
                                        @endif
