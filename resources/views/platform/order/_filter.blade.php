        ...
        <form id="search-form">
            ...
            <div class="mb-10">
                ...
                <select name="filter_status" class="form-select form-select-solid fw-bolder"  id="filter_status" data-kt-select2="true"
                    ...
                    <option value="14">Payment Pending</option>
                    <option value="6">Cancel Requested</option>
                </select>
            </div>
            <div class="mb-10">
                <label class="form-label fs-6 fw-bold">Coupon Status:</label>
                <select name="coupon_status" class="form-select form-select-solid fw-bolder"  id="coupon_status" data-kt-select2="true"
                    data-placeholder="Select option" data-allow-clear="true" data-kt-order-table-filter="order"
                    data-hide-search="true">
