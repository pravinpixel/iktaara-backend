...
@section('add_on_script')
    ...
    <script>
        var dtTable = $('#order-table').DataTable({
            ...
            ajax: {
                ...
                "data": function(d) {
                    ...
                    d.coupon_status = $('select[name=coupon_status]').val();
            ...
            columns: [
                ...
                {
                    data: 'shipment_tracking_code',
                    name: 'shipment_tracking_code'
                },
                {
                    data: 'shipment_tracking_message',
                    name: 'shipment_tracking_message'
                },
                {
                    data: 'billing_info',
                    name: 'billing_info',
        ...
        $('#search-form').on('reset', function(e) {
            ...
            $('select[name=coupon_status]').val('all').change();
            dtTable.draw();
            e.preventDefault();
        });
