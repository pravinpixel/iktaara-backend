...
<div class="w-100 border-top">
    <div class="row px-10 mt-5 mb-5">
        <div class="col-sm-8">
            <h2>Is Brand Featured? </h2>
        </div>
        <div class="col-sm-4">
            <div class="form-check form-switch form-check-custom form-check-solid fw-bold fs-6 mb-2">
                <input class="form-check-input" type="checkbox"  name="is_brand_featured" value="1"  @if(isset( $info->is_brand_featured) && $info->is_brand_featured == '1') checked @endif />
            </div>
        </div>
    </div>
</div>
