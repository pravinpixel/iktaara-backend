    ...
    <div class="card">
        <div class="card-header">
            <ul class="nav nav-custom nav-tabs nav-line-tabs nav-line-tabs-2x border-0 fs-4 fw-bold mb-0 align-items-center">
                ...
                <li class="nav-item">
                    <a class="nav-link text-active-primary" data-bs-toggle="tab" href="#kt_ecommerce_add_category_faq">FAQ</a>
                </li>
            </ul>
        </div>
        <div class="card-body">
                            ...
                            <div class="fv-row mb-1">
                                <div class="d-flex flex-column scroll-y me-n7 pe-7 py-4" id="kt_modal_add_user_scroll"
                                    ...
                                    <div class="tab-content">
                                        ...
                                        <div class="tab-pane fade" id="kt_ecommerce_add_category_faq" role="tab-panel">
                                            @include('platform.common.form._faq')
                                        </div>
                                    </div>
                                </div>
                            </div>
