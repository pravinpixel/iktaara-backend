    ...
    <div id="kt_content_container" class="container-xxl">
        <div class="card">
            <div class="card-header border-0 pt-6 w-100">
                @include('platform.reports.products._order_filter_form')
            </div>
            <hr>
            <!--end::Card header-->
            <!--begin::Card body-->
    ...
    <script>
        ...
        function exportProductExcel() {
            ...
            $.ajax({
                ...
                url: "{{ route('orderreports.export.excel') }}",
                type: 'POST',
                ...
                success: function(result, status, xhr) {
                    ...
                    var filename = (matches != null && matches[1] ? matches[1] : 'order_report.xlsx');
